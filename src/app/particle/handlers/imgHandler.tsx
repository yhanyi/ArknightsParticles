...
private static initializeCanvas() {
    ...
    ImgHandler.ctx = ImgHandler.canvas.getContext('2d') as CanvasRenderingContext2D;
}

constructor(private length: number) {
    // Initialize canvas and ctx only once when the class is used
    if (!ImgHandler.canvas) {
      ImgHandler.initializeCanvas();
    }
  }
