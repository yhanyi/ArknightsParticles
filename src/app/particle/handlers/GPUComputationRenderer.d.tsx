declare module "three/examples/jsm/misc/GPUComputationRenderer" {
    import { WebGLRenderer, WebGLRenderTarget, ShaderMaterial, Texture, TextureDataType, IUniform, DataTexture, Wrapping, Material, MagnificationTextureFilter, MinificationTextureFilter } from "three";
